...
df.exp1 = df.exp1 %>% 
  mutate(po = str_extract(po, "[:digit:]"),
         ...
         ro = str_extract(po, "[:digit:]"),
         rs = str_extract(po, "[:digit:]"),
         rf = str_extract(po, "[:digit:]"),
         rbo = str_extract(po, "[:digit:]"),
         rbs = str_extract(po, "[:digit:]"),
         rbf = str_extract(po, "[:digit:]"),
         ho = str_extract(po, "[:digit:]"),
         hs = str_extract(po, "[:digit:]"),
         hf = str_extract(po, "[:digit:]"),
         co = str_extract(po, "[:digit:]"),
         cs = str_extract(po, "[:digit:]"),
         cf = str_extract(po, "[:digit:]"))
